    ...
    class linq
    {
        static void Main(string[] args)
        {
            ...
            var ename2 = from e in elist
              ...
              ename2.ToList().ForEach(e => Console.WriteLine(e.EmpName));

            var empGroupBy= from e in elist group e by e.EmpId into ep orderby ep.Key select new { ep.Key, ep };
